...
const steps: FlowStep[] = [
  {
    id: 1,
    label: "Morning",
    title: "30g protein within 1 hour of waking",
    description: "Your muscle mass dropped 4 lbs since October. Every morning protein window counts — eggs, Greek yogurt, or a shake. This also helps stabilize glucose before your HRV can recover.",
  ...
  },
  {
    id: 2,
    label: "Movement",
    title: "20-min walk — no intensity today",
    description: "HRV at 19ms + TSH elevated = your nervous system is under load. A walk gives you NEAT steps toward your 7,000 goal without digging deeper into recovery debt. Skip the gym or keep it to mobility only.",
  ...
  },
  {
    id: 3,
    label: "Tonight",
    title: "PM stack before 10pm — don't skip",
    description: "You missed the PM stack 3 nights this week. Magnesium glycinate + L-Theanine directly supports HRV and deep sleep. Take it by 9:30pm so it's active when you fall asleep.",
